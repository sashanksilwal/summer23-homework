# solved-homework 2-2: Path Algebra and J
```
module solved-homework.2--Paths-and-Identifications.2-2--Path-Algebra-and-J where
...
open import solved-homework.2--Paths-and-Identifications.2-1--Paths using (refl ; cong)
